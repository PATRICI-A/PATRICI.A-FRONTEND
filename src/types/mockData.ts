...
import imgConquistadorCampus from '../assets/ConocidoDelCampus.png';
import imgLeyendaCampus from '../assets/LaLeyendaPatric.ia-2.png';
import imgAnfitrion from '../assets/Anfitrion.png';
import imgCapitanEquipo from '../assets/CapitanNato.png';
import imgConectorVeloz from '../assets/Viral.png';
import imgIniciadorParche from '../assets/ParcheIniciado.png';
import imgNetworking25 from '../assets/NETWORKING 50.png';
import imgNetworking5 from '../assets/NETWORKING 10.png';
import imgOrganizadorElite from '../assets/ElPrevisor.png';
import imgPrimerContacto from '../assets/PrimerChoque-1.png';
import imgPrimerMensajero from '../assets/ElRompeHielos.png';
import imgMaratonUniversitaria from '../assets/ATLETA DE PATIO.png';
...
export const wellnessResources: WellnessResource[] = [
  { id: 'w1', name: 'Medicina General ECI', description: 'Consultas médicas generales, control de enfermedades y seguimiento de salud estudiantil.', category: 'SALUD', schedule: 'Lun–Vie 8:00 AM – 5:00 PM', contact: '', location: 'Bloque A, Piso 1', active: true },
  { id: 'w2', name: 'Enfermería y Primeros Auxilios', description: 'Atención de urgencias menores, primeros auxilios y acompañamiento en emergencias.', category: 'SALUD', schedule: 'Lun–Vie 7:00 AM – 7:00 PM', contact: '', location: 'Entrada Principal', active: true },
  { id: 'w3', name: 'Nutrición y Alimentación Saludable', description: 'Asesoría nutricional personalizada para mejorar hábitos alimenticios y rendimiento académico.', category: 'SALUD', schedule: 'Mar y Jue 10:00 AM – 3:00 PM', contact: '', location: 'Bienestar, Bloque A', active: false },
  { id: 'w4', name: 'Liga de Fútbol Interfacultades', description: 'Torneos y entrenamientos de fútbol sala entre facultades, abiertos a todos los niveles.', category: 'DEPORTE', schedule: 'Lun, Mié y Vie 4:00 PM – 6:00 PM', contact: '', location: 'Canchas Los Pinos', active: true },
  { id: 'w5', name: 'Yoga y Pilates', description: 'Clases de yoga y pilates para reducir el estrés y mejorar la flexibilidad y concentración.', category: 'DEPORTE', schedule: 'Mar y Jue 12:00 PM – 1:00 PM', contact: '', location: 'Sala Polideportiva', active: true },
  { id: 'w13', name: 'Baile y Danza', description: 'Clases de salsa, merengue y ritmos urbanos. Abierto a todos los niveles, sin experiencia previa necesaria.', category: 'DEPORTE', schedule: 'Mié y Vie 5:00 PM – 7:00 PM', contact: '', location: 'Sala Polideportiva', active: true },
  { id: 'w7', name: 'Grupo de Teatro', description: 'Taller de actuación y expresión corporal. Presentaciones semestrales abiertas a la comunidad.', category: 'CULTURA', schedule: 'Viernes 3:00 PM – 6:00 PM', contact: '', location: 'Auditorio B', active: true },
  { id: 'w10', name: 'Psicología Estudiantil', description: 'Atención psicológica individual y grupal. Apoyo en crisis, duelo, ansiedad y salud emocional.', category: 'MENTAL_HEALTH', schedule: 'Lun–Vie 8:00 AM – 5:00 PM', contact: '', location: 'Bloque A, Piso 2', active: true, phone: '601 745 6390 ext. 101' },
  { id: 'w11', name: 'Grupo de Apoyo: Estrés Académico', description: 'Sesiones grupales para manejar el estrés, la procrastinación y la presión del rendimiento académico.', category: 'MENTAL_HEALTH', schedule: 'Martes 4:00 PM – 6:00 PM', contact: '', location: 'Sala Bienestar', active: true },
  { id: 'w12', name: 'Orientación Vocacional y Proyecto de Vida', description: 'Acompañamiento en decisiones de carrera, exploración vocacional y construcción del proyecto de vida.', category: 'MENTAL_HEALTH', schedule: 'Lun–Vie 9:00 AM – 4:00 PM', contact: '', location: 'Bloque A, Piso 2', active: true },
];
